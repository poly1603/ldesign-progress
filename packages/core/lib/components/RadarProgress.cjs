...
class RadarProgress extends ProgressBase.ProgressBase {
  constructor() {
    super(...arguments);
    this.scanAngle = 0;
  }
  ...
  render() {
    ...
    this.wrapper = helpers.createElement("div", "ld-progress-radar", this.container);
    ...
    this.canvas = helpers.createElement("canvas", "ld-progress-radar__canvas", this.wrapper);
    this.canvas.width = size;
    this.canvas.height = size;
    this.ctx = MemoryManager.canvasContextCache.get(this.canvas);
    if (this.config.get("showText")) {
      this.textElement = helpers.createElement("div", "ld-progress-radar__text", this.wrapper);
...
exports.RadarProgress = RadarProgress;
//# sourceMappingURL=RadarProgress.cjs.map
