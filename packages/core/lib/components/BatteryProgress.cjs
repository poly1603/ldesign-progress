...
class BatteryProgress extends ProgressBase.ProgressBase {
  getDefaultOptions() {
    return {
  ...
  render() {
    ...
    this.wrapper = helpers.createElement("div", "ld-progress-battery", this.container);
    ...
    if (orientation === "horizontal") {
      ...
      this.wrapper.style.width = helpers.toPx(height);
      this.wrapper.style.height = helpers.toPx(width);
    }
    this.wrapper.style.display = "inline-flex";
    this.wrapper.style.alignItems = "center";
    this.wrapper.style.position = "relative";
    this.battery = helpers.createElement("div", "ld-progress-battery__body", this.wrapper);
    ...
    this.fill = helpers.createElement("div", "ld-progress-battery__fill", this.battery);
    ...
    this.head = helpers.createElement("div", "ld-progress-battery__head", this.wrapper);
    if (orientation === "horizontal") {
    ...
    if (this.config.get("showText")) {
      this.textElement = helpers.createElement("div", "ld-progress-battery__text", this.battery);
  ...
  renderBoltIcon() {
    const svg = helpers.createSVGElement("svg", {
      width: "20",
      height: "20",
      viewBox: "0 0 24 24",
...
exports.BatteryProgress = BatteryProgress;
//# sourceMappingURL=BatteryProgress.cjs.map
