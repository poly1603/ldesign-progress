...
class RingProgress extends ProgressBase.ProgressBase {
  constructor() {
    super(...arguments);
    this.ringElements = [];
  }
  ...
  render() {
    ...
    rings.forEach((ring, index) => {
      ...
      const track = helpers.createSVGElement("circle", {
        cx: center,
        cy: center,
        r: radius,
        fill: "none",
      ...
      const progress = helpers.createSVGElement("circle", {
        cx: center,
        cy: center,
        r: radius,
        fill: "none",
      ...
      if (ring.label) {
        ...
        textElement = helpers.createSVGElement("text", {
          x: center,
          y: labelY,
          "text-anchor": "middle",
          fill: "#606266",
