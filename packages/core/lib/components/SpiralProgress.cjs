...
class SpiralProgress extends ProgressBase.ProgressBase {
  constructor() {
    super(...arguments);
    this.pathLength = 0;
  }
  ...
  render() {
    ...
    const bgPath = helpers.createSVGElement("path", {
      d: pathData,
      fill: "none",
      stroke: "#e4e7ed",
    ...
    this.spiralPath = helpers.createSVGElement("path", {
      d: pathData,
      fill: "none",
      "stroke-width": this.config.get("strokeWidth") || 6,
      "stroke-linecap": "round",
...
exports.SpiralProgress = SpiralProgress;
//# sourceMappingURL=SpiralProgress.cjs.map
