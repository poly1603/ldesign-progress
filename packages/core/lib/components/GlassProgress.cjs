...
class GlassProgress extends ProgressBase.ProgressBase {
  getDefaultOptions() {
    return {
  ...
  render() {
    ...
    this.wrapper = helpers.createElement("div", "ld-progress-glass", this.container);
    ...
    this.track = helpers.createElement("div", "ld-progress-glass__track", this.wrapper);
    ...
    this.bar = helpers.createElement("div", "ld-progress-glass__bar", this.track);
    ...
    if (this.config.get("showText")) {
      this.textElement = helpers.createElement("div", "ld-progress-glass__text", this.wrapper);
...
//# sourceMappingURL=GlassProgress.cjs.map
