...
import { memoryMonitor } from '../utils/MemoryManager.js';
import '../utils/RAFController.js';
import { PluginManager, MiddlewareManager } from '../utils/PluginSystem.js';

class ProgressBase extends EventEmitter {
  constructor(container, options) {
    super();
    this.destroyed = false;
    this.pluginManager = new PluginManager();
    this.valueMiddleware = new MiddlewareManager();
    ...
    this.config = new ConfigManager(this.getDefaultOptions());
    if (options) {
...
export { ProgressBase };
//# sourceMappingURL=ProgressBase.js.map
