...
class PolygonProgress extends ProgressBase.ProgressBase {
  getDefaultOptions() {
    return {
  ...
  render() {
    ...
    this.trackPolygon = helpers.createSVGElement("polygon", {
      points: pointsString,
      fill: "none",
    ...
    this.progressPolygon = helpers.createSVGElement("polygon", {
      points: pointsString,
      fill: "none",
      "stroke-width": strokeWidth,
  ...
  generatePolygonPoints(sides, radius, rotation, center) {
    ...
    const rotationRad = helpers.degToRad(rotation);
...
exports.PolygonProgress = PolygonProgress;
//# sourceMappingURL=PolygonProgress.cjs.map
