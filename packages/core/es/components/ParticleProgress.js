...
class ParticleProgress extends ProgressBase {
  constructor() {
    super(...arguments);
    this.particles = [];
  }
  ...
  render() {
    ...
    this.canvas = createElement("canvas", "ld-progress-particle__canvas", this.wrapper);
...
export { ParticleProgress };
//# sourceMappingURL=ParticleProgress.js.map
