...
class BubbleProgress extends ProgressBase {
  constructor() {
    super(...arguments);
    this.bubbles = [];
  }
  ...
  render() {
    ...
    this.canvas = createElement("canvas", "ld-progress-bubble__canvas", this.wrapper);
...
export { BubbleProgress };
//# sourceMappingURL=BubbleProgress.js.map
