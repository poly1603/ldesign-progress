...
class LiquidProgress extends ProgressBase {
  constructor() {
    super(...arguments);
    this.waveOffset = 0;
  }
  ...
  render() {
    ...
    this.canvas = createElement("canvas", "ld-progress-liquid__canvas", this.wrapper);
...
//# sourceMappingURL=LiquidProgress.js.map
