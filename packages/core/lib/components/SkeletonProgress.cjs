...
class SkeletonProgress extends ProgressBase.ProgressBase {
  getDefaultOptions() {
    return {
  ...
  render() {
    ...
    this.wrapper = helpers.createElement("div", "ld-progress-skeleton", this.container);
    ...
    this.track = helpers.createElement("div", "ld-progress-skeleton__track", this.wrapper);
    ...
    if (this.config.get("showShimmer")) {
      this.shimmer = helpers.createElement("div", "ld-progress-skeleton__shimmer", this.track);
    ...
    if (this.config.get("showText")) {
      this.textElement = helpers.createElement("div", "ld-progress-skeleton__text", this.wrapper);
...
exports.SkeletonProgress = SkeletonProgress;
//# sourceMappingURL=SkeletonProgress.cjs.map
