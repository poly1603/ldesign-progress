...
class RippleProgress extends ProgressBase.ProgressBase {
  constructor() {
    super(...arguments);
    this.ripples = [];
  }
  ...
  render() {
    ...
    this.wrapper = helpers.createElement("div", "ld-progress-ripple", this.container);
    ...
    this.canvas = helpers.createElement("canvas", "ld-progress-ripple__canvas", this.wrapper);
    this.canvas.width = size;
    this.canvas.height = size;
    this.ctx = MemoryManager.canvasContextCache.get(this.canvas);
    if (this.config.get("showText")) {
      this.textElement = helpers.createElement("div", "ld-progress-ripple__text", this.wrapper);
...
exports.RippleProgress = RippleProgress;
//# sourceMappingURL=RippleProgress.cjs.map
